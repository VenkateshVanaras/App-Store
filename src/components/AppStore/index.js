...
class AppStore extends Component {
  ...
  getResultApps = () => {
    ...
    const resultApps = appsList.filter(
      eachTabList => eachTabList.category === activeTabId,
    )
    return resultApps
  }
  ...
  render() {
    ...
    const resultAppsList = this.getResultApps()
    const resultApps = resultAppsList.filter(eachApp =>
      eachApp.appName.toLowerCase().includes(inputValue.toLocaleLowerCase()),
    )
